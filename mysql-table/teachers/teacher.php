    ...
    <div class="container-fluid">
        <div class="container">
            <div class="m-5 shadow-lg bg-light p-3">
                <h1 style ="font-family:'fantasy'" class="text-center text-dark mb-5">TEACHERS</h1>
                <a href="create.php"><button style ="float:right;" class=" btn pl-5 pr-5 pt-2 pb-2 mb-4  btn-outline-dark">Add Data</button></a>
