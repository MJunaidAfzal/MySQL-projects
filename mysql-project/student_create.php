    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <form action="student_store.php" method="POST">
                    ...
                    <input style="background-color:grey;color: gold;border: 4px gold groove;" type="text" class="form-control" name="student_name" required>
             
                    <label class ="mt-3" for="age">Age</label>
                    <input style="background-color:grey;color: gold;border: 4px gold groove;" type="text" class="form-control" name="age" required>
             
                    <label class ="mt-3" for="subject">Subject</label>
                    <input style="background-color:grey;color: gold;border: 4px gold groove;" type="text" class="form-control" name="subject" required>
            
                    <label class ="mt-3" for="teacher_id">Teacher_id</label>
                    <input style="background-color:grey;color: gold;border: 4px gold groove;" type="text" class="form-control" name="teacher_id" required>
