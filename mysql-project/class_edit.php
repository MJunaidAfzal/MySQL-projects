    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <input type="hidden" name="id" value="<?php echo $row['id']; ?>" required>           
                    ...
                    <input style="background-color: black;color: white;border: 4px white groove;" type="text" class="form-control" name="class_name" value="<?php echo $row['class_name']; ?>" required>
             
                    <label class ="mt-3" for="room_no">Room Number</label>
                    <input style="background-color: black;color: white;border: 4px white groove;" type="text" class="form-control" name="room_no"  value="<?php echo $row['room_no']; ?>" required>
             
                    <label class ="mt-3" for="building_no">Building Number</label>
                    <input style="background-color: black;color: white;border: 4px white groove;" type="text" class="form-control" name="building_no"  value="<?php echo $row['building_no']; ?>" required>
